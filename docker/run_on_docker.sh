...
case ${CVMFS_DOCKER_IMAGE} in
  ...
  "debian11_aarch64")
    ...
    ;;
  "ubuntu2604_aarch64")
    image_name="gitlab-registry.cern.ch/cernvm/build-images/ubuntu_aarch64:26.04"
    docker pull $image_name
    ;;
  "ubuntu2604_x86_64")
    image_name="gitlab-registry.cern.ch/cernvm/build-images/ubuntu_x86_64:26.04"
    docker pull $image_name
    ;;
  "ubuntu2510_aarch64")
  ...
  "sles15_aarch64")
    ...
    ;;
  "fedora44_aarch64")
    image_name="gitlab-registry.cern.ch/cernvm/build-images/fedora_aarch64:44"
    docker pull $image_name
    ;;
  "fedora43_aarch64")
    image_name="gitlab-registry.cern.ch/cernvm/build-images/fedora_aarch64:43"
    docker pull $image_name
    ;;
  "fedora42_aarch64")
  ...
  "fedora42_x86_64")
    ...
    ;;
  "fedora43_x86_64")
    image_name="gitlab-registry.cern.ch/cernvm/build-images/fedora_x86_64:43"
    docker pull $image_name
    ;;
  "fedora44_x86_64")
    image_name="gitlab-registry.cern.ch/cernvm/build-images/fedora_x86_64:44"
    docker pull $image_name
    ;;
  "fedora40_x86_64")
