...
GO_COMPILE_SCRIPT="github.com/cvmfs/docker-graphdriver/ci/jenkins/build_docker2cvmfs.sh"
...
if is_docker_host; then
  echo "creating docker2cvmfs Go binary on docker for ${desired_architecture} and sending output to $CVMFS_BUILD_LOCATION..."
